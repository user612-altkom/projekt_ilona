# Dodatkowe wymagania (karty zmiany)

Źródło: [agentGreg/harmonogram-polstr-szablon, dodatkowe_wymagania.md](https://github.com/agentGreg/harmonogram-polstr-szablon/blob/main/dodatkowe_wymagania.md).
Wdrażane w kolejności CR-A → CR-B → CR-C, każda jako osobny PR, zgodnie z KARTA.md (Bramka 3).
...
1. Każda nadpłata ma tryb: „skróć okres" albo „obniż ratę". Brak trybu oznacza
   „skróć okres".
2. „Obniż ratę": liczba rat bez zmian, rata przeliczona na pozostałe raty od salda po
   nadpłacie.
3. „Skróć okres": rata bez zmian, harmonogram kończy się wcześniej, ostatnia rata
   wyrównująca.
...
4. Harmonogram pokazuje, od którego wiersza obowiązuje nowy wskaźnik (kolumna lub
   znacznik).
